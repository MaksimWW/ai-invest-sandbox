...
def test_sentiment_debug():
    ...
    # Расширенные тестовые тексты с фокусом на нейтральные случаи
    test_cases = [
        ...
        ("Торги прошли без существенных изменений", "ru", "neutral"),
        ("Котировки держатся в прежнем диапазоне", "ru", "neutral"),
