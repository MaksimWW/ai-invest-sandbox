...
def test_sentiment_improvements():
    ...
    # Расширенные тестовые случаи с ожидаемыми результатами
    test_cases = [
        # Явно позитивные (финансовые термины)
        ...
        ("Выручка компании достигла рекордного уровня", "positive"),
        ("Акции взлетели на 20% после новостей о слиянии", "positive"),
        ...
        ("Цены обвалились после плохих финансовых результатов", "negative"),
        ("Компания понесла значительные убытки в квартале", "negative"),
        ...
        ("Компания опубликовала квартальный отчет", "neutral"),
        ("Совет директоров проведет заседание в четверг", "neutral"),
    ]
